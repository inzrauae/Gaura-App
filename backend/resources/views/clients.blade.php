...
<body>
  ...
  <div class="flex min-h-screen flex-col md:ml-64">
    ...
    <main class="mx-auto w-full max-w-6xl flex-1 p-6 pb-24 md:p-10 md:pb-10">
      <div class="mb-8">
        <h1 class="text-3xl font-extrabold text-[#003d9b]">Clients CMS</h1>
      ...
      <section class="mb-8 rounded-xl border border-slate-100 bg-white p-6 shadow-sm">
      ...
      <section class="overflow-hidden rounded-xl border border-slate-100 bg-white shadow-sm">
        <div class="border-b border-slate-100 px-5 py-4">
          <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <form method="GET" action="{{ route('clients') }}" class="flex items-center gap-2">
              ...
              <input
                ...
                class="w-64 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm focus:border-[#003d9b] focus:ring-[#003d9b]"
              />
