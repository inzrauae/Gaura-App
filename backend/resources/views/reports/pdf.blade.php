...
<head>
    ...
    <title>GAURA - Expense Report</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tbody>
                    @foreach($byProject as $project => $data)
                    <tr>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $expense->project_name ?? 'Unassigned' }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" style="text-align: center; color: #999;">No expenses found</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
